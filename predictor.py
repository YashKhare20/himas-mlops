...
class CustomPredictor(Predictor):
    ...
    def load(self, artifacts_uri: str):
        ...
        # Load preprocessing artifacts - CORRECT: single preprocessing folder
        with open("preprocessing/feature_order.pkl", "rb") as f:
            self.feature_order = pickle.load(f)
        with open("preprocessing/scaler.pkl", "rb") as f:
            self.scaler = pickle.load(f)
        with open("preprocessing/label_encoders.pkl", "rb") as f:
