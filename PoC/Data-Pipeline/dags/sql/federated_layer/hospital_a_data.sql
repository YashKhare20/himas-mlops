-- ----------------------------------------------------------------------------
-- Hospital A: ICU Mortality Prediction (40% of patients - Random)
-- ----------------------------------------------------------------------------
CREATE OR REPLACE TABLE `erudite-carving-472018-r5.federated_demo.hospital_a_data` AS
SELECT cf.*,
  ...
  psa.data_split,
  -- LABEL: ICU Mortality (death during or after ICU stay)
  CASE
