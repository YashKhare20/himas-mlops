-- ----------------------------------------------------------------------------
-- Hospital C: ICU Mortality Prediction (25% of patients - Random)
-- ----------------------------------------------------------------------------
CREATE OR REPLACE TABLE `erudite-carving-472018-r5.federated_demo.hospital_c_data` AS
SELECT cf.*,
  ...
  psa.data_split,
  -- LABEL: ICU Mortality (same as Hospital A & B)
  CASE
...
WHERE psa.assigned_hospital = 'hospital_c';